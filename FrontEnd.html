...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ACTION BUTTONS */
        .btn-edit, .btn-delete, .btn-devolver {
            padding: 6px 12px;
            margin-right: 5px;
            border: none;
            border-radius: 5px;
    ...
    <div class="container">
        ...
        <header class="header">
            ...
            <nav class="nav">
                ...
                <button class="nav-btn" data-page="usuarios">Usuários</button>
                <button class="nav-btn" data-page="livros">Livros</button>
                <button class="nav-btn" data-page="emprestimos">Empréstimos</button>
            </nav>
        </header>
        ...
        <main class="main">
            ...
            <section id="home" class="page active">
                <div class="welcome">
                    ...
                    <p>Gerencie usuários, livros e empréstimos de forma simples e eficiente.</p>
                    <div class="stats">
                        <div class="stat-card">
            ...
            <section id="usuarios" class="page">
                ...
                <div class="form-container">
                    ...
                    <form id="form-usuario">
                        ...
                        <input type="text" id="usuario-matricula" placeholder="Matrícula" required>
            ...
            <section id="livros" class="page">
                ...
                <div class="form-container">
                    ...
                    <form id="form-livro">
                        ...
                        <input type="number" id="livro-ano" placeholder="Ano de Publicação">
                        <input type="text" id="livro-categoria" placeholder="Categoria">
                        <input type="text" id="livro-isbn" placeholder="ISBN">
            ...
            <section id="emprestimos" class="page">
                ...
                <div class="form-container">
                    ...
                    <form id="form-emprestimo">
                        ...
                        <input type="number" id="emprestimo-dias" placeholder="Dias de Empréstimo" value="7" min="1">
        ...
        <!-- FOOTER -->
        <footer class="footer">
            <p>&copy; 2024 Sistema de Biblioteca Universitária. Todos os direitos reservados.</p>
        </footer>
    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.nav-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                // Carrega dados quando mudar de página
        ...
        async function carregarLivros() {
            try {
                ...
                // Carregar livros no select de empréstimos
        ...
        document.getElementById('form-livro').addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch(`${API_URL}/livros`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ titulo, autor, ano_publicacao, categoria, isbn })
                });
        ...
        async function carregarEmprestimos() {
            try {
                ...
                emprestimos.forEach(emp => {
                    const tr = document.createElement('tr');
                    const dataDevolucao = emp.data_devolucao ? emp.data_devolucao : '-';
                    const multa = emp.multa ? `R$ ${parseFloat(emp.multa).toFixed(2)}` : 'R$ 0,00';
                    const btnDevolver = emp.data_devolucao ? '' : 
                        `<button class="btn-devolver" onclick="devolverLivro(${emp.id_emprestimo})">Devolver</button>`;
        ...
        async function devolverLivro(id) {
            try {
                ...
                if (response.ok) {
                    ...
                    alert(`Livro devolvido com sucesso!\nMulta: R$ ${parseFloat(result.multa).toFixed(2)}`);
                    carregarEmprestimos();
                    carregarLivros();
                    carregarEstatisticas();
                }
